...
[![GoDoc](https://godoc.org/github.com/sjatsh/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/sjatsh/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/sjatsh/btcwallet/walletdb

## Installation

```bash
$ go get github.com/sjatsh/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/sjatsh/btcwallet/walletdb#example-package--BasicUsage)  
